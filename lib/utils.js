...
export async function apiCall(path, opts = {}, token = null) {
  ...
  if (!res.ok) {
    ...
    if (data.maintenance) err.maintenance = data.message || 'Platform is under maintenance. Back shortly.';
    throw err;
  }
  return data;
}
...
export const KENYA_TOWNS = [
  'Nairobi CBD','Westlands','Kilimani','Lavington','Karen','Lang\'ata','South B','South C',
  'Eastleigh','Pangani','Parklands','Upperhill','Hurlingham','Kileleshwa','Ruaka','Ruiru',
  'Thika','Juja','Githurai','Kasarani','Roysambu','Zimmerman','Kahawa','Kahawa Wendani',
  'Mombasa CBD','Nyali','Bamburi','Shanzu','Likoni','Diani','Ukunda','Malindi','Kilifi',
  'Kisumu CBD','Kisumu West','Kisumu East','Milimani','Mamboleo','Kondele','Busia',
  'Nakuru CBD','Ngata','Lanet','Pipeline','Bahati','Molo','Naivasha','Gilgil',
  'Eldoret CBD','Langas','Huruma','Pioneer','Annex','Kapsabet','Nandi Hills',
  'Kiambu','Ruiru','Limuru','Kikuyu','Tigoni','Karuri','Wangige','Banana',
  'Machakos','Athi River','Mavoko','Mlolongo','Syokimau','Kitengela','Rongai','Ngong',
  'Meru CBD','Nkubu','Timau','Chuka','Embu CBD','Kirinyaga','Sagana','Karatina',
  'Nyeri CBD','Karatina','Othaya','Nanyuki','Isiolo','Maua',
  'Garissa','Wajir','Mandera','Moyale','Marsabit','Isiolo',
  'Kisii CBD','Awendo','Migori','Homa Bay','Kendu Bay','Rongo','Oyugis','Siaya',
  'Kakamega','Mumias','Bungoma','Webuye','Malaba','Kitale','Eldoret North',
  'Lamu','Malindi','Watamu','Kilifi','Voi','Taveta','Wundanyi',
].sort();
...
export { cloudinaryUrl, imgThumb, imgCard, imgFull, imgAvatar } from '@/lib/cloudinary';
export { useDebounce, useSubmitGuard, useRateLimit, useThrottle } from '@/lib/rateLimiting';
