...
export const metadata = {
  ...
  description: "Kenya's trusted marketplace. Post free. Pay KSh 260 only when a serious buyer locks in. Safe anonymous chat, M-Pesa escrow.",
  ...
  openGraph: {
    ...
    description: "Post free. Pay KSh 260 only when a buyer locks in. Safe anonymous chat, M-Pesa escrow.",
    url: BASE,
    siteName: 'Weka Soko',
    locale: 'en_KE',
    type: 'website',
